ActiveAdmin.register_page 'South Africa Platform Data Sources' do
  ...
  controller do
    ...
    def path
      admin_south_africa_platform_data_sources_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_south_africa_platform_data_sources_upload_datafile_path,
      download_path: admin_south_africa_platform_data_sources_download_datafiles_path,
      download_single_data_file_path:
          admin_south_africa_platform_data_sources_download_datafile_path,
      import_path: admin_south_africa_platform_data_sources_run_importer_path,
