ActiveAdmin.register_page 'South Africa Platform Mitigation Actions' do
  include DataUploader::SharedAdmin

  section_name = 'mitigation_actions'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX_TEST}mitigation_actions"
    end

    def path
      admin_south_africa_platform_mitigation_actions_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_south_africa_platform_mitigation_actions_upload_datafile_path,
      download_path: admin_south_africa_platform_mitigation_actions_download_datafiles_path,
      download_single_data_file_path:
          admin_south_africa_platform_mitigation_actions_download_datafile_path,
      import_path: admin_south_africa_platform_mitigation_actions_run_importer_path,
