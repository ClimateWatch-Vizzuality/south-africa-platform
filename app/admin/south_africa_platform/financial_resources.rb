ActiveAdmin.register_page 'South Africa Platform Financial Resources' do
  include DataUploader::SharedAdmin

  section_name = 'financial_resources'
  ...
  controller do
    ...
    def path
      admin_south_africa_platform_financial_resources_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_south_africa_platform_financial_resources_upload_datafile_path,
      download_path: admin_south_africa_platform_financial_resources_download_datafiles_path,
      download_single_data_file_path:
          admin_south_africa_platform_financial_resources_download_datafile_path,
      import_path: admin_south_africa_platform_financial_resources_run_importer_path,
