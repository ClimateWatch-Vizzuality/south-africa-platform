...
const initialLineWithDotsColumns = [
  { label: 'All GHG', value: 'yAllGhg' },
  { label: 'CO2', value: 'yCo2' },
  { label: 'CH4', value: 'yCh4' },
  { label: 'N2O', value: 'yN2O' },
...
const initialRangedAreaColumns = [
  { label: 'ppd', value: 'ppd' },
  { label: 'BaU', value: 'bau' }
];

const initialDotsColumns = [
  { label: 'GHG Inventory', value: 'ghgInventory' }
];

const initialLineColumns = [ { label: 'LTMs', value: 'ltms' } ];
...
const domain = { x: [ 'auto', 'auto' ], y: [ null, 'auto' ] };
